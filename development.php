...
<body>
 ...
 <?php include('header.php');?>
        ...
        <!--Page Title-->
        <section class="page-title" style="background-image:url(images/background/aboutus.jpeg);">
            <div class="auto-container">
                <h1  style ="color:#1e272e;">Contact Us</h1>
            </div>
        </section>
        <!--Page Title end-->
                        ...
                        <div class="contact-form default-form">
                            <form method="post" action="#" id="contact-form" novalidate="novalidate">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12" style ="color:#2e86de;">
                                        <button type="submit" class="btn-one" style ="color:#2e86de;">SEND</button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="contact-info">
                                <ul>
                                    ...
                                    <li>
                                        <span class="icon flaticon-envelope-1" style ="color:#2e86de;"></span>
                                        <h3>Email</h3> contact@myproject-solution.com <br>
										 sales@myproject-solution.com<br>
										 helpdesk@myproject-solution.com
                                    </li>
                                    <li>
                                        <span class="icon flaticon-phone-call"  style ="color:#2e86de;"></span>
                                        <h3>Mobile NO:</h3> 08840939231
                                    </li>
									 <li>
                                        <span class="icon flaticon-phone-call" style ="color:#2e86de;"></span>
                                        <h3>Facebook Message</h3>https://www.facebook.com/myprojectsolutionss/
                                    </li>
                                </ul>
                            </div>
                        </div>
