...
<body>
 ...
 <?php include('header.php');?>
        ...
        <!--Page Title-->
        <section class="page-title" style="background-image:url(images/background/common.jpeg);">
            <div class="auto-container">
                <h1  style ="color:#1e272e;">IT Consultancy</h1>
            </div>
        </section>
        <!--Page Title end-->
                        ...
                        <div class="weltext">
                            <h2>IT Consultancy.
                             ...
                             <div class="default-text-block">
                                <p>IT sectors has increased widely and many companies has marked their presence, but we can’t ignore the 
								fact that there are many technologies, and companies can’t deal in all technologies.
								If you have a good knowledge then also sometimes we lack in it, so now to guide in a proper manner and to save you from the loss IT Firms consultancy has marked their presence which makes the IT firms more advanced and reliable. <br>
								</p>
							...
							<br>
									  <div class="weltext">
									   <h2>Why Choose MyProject-solution IT Solutions
										</h2>
									...
									<div class="weltext">
									   <h2>Experience in IT field:
										</h2>
										 <p>We have a best experience in the IT field since years, we can deal in every technology and are aware of it.</p>
										
										
									</div>
									<div class="weltext">
									   <h2>Team of IT Experts: 
										</h2>
										 <p>
										 We have the team of professionals and includes the experts from all over the world.
									...
									<div class="weltext">
									   <h2>Guarantee recovery before deadline:
										</h2>
										 <p>
										 We guarantee you if we have your project so we will recover it before the deadline, it won't get late.
